...
public class GrpcReflectionTest {
    ...
    @Inject @GrpcService("reflection-service") MutinyServerReflectionGrpc.MutinyServerReflectionStub reflection;
    ...
    public void testRetrievingFilesByFileName() {
        ...
        ServerReflectionResponse expected =
