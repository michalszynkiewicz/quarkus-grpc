...
public class GrpcHealthTest {
    ...
    public void shouldGetHealthInfoFromMultipleStreams() {
        ...
        awaitExactStatusList(statusList1, ServingStatus.UNKNOWN, ServingStatus.NOT_SERVING, ServingStatus.SERVING, ServingStatus.NOT_SERVING);
        awaitExactStatusList(statusList2, ServingStatus.UNKNOWN, ServingStatus.NOT_SERVING, ServingStatus.SERVING, ServingStatus.NOT_SERVING);
    ...
    static class HealthConsumer {
        ...
        public HealthCheckResponse.ServingStatus checkStatus(Function<HealthOuterClass.HealthCheckRequest.Builder, HealthOuterClass.HealthCheckRequest.Builder> decorator) {
        ...
        public Multi<HealthCheckResponse> getStatusStream(Function<HealthOuterClass.HealthCheckRequest.Builder, HealthOuterClass.HealthCheckRequest.Builder> decorator) {
            HealthOuterClass.HealthCheckRequest.Builder builder = decorator.apply(HealthOuterClass.HealthCheckRequest.newBuilder());
