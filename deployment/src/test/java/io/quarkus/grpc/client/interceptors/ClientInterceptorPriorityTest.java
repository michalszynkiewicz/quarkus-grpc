...
public class ClientInterceptorPriorityTest {
    ...
    @Inject MyFirstClientInterceptor interceptor1;
    @Inject MySecondClientInterceptor interceptor2;

    @Inject @GrpcService("hello-service") GreeterGrpc.GreeterBlockingStub client;
