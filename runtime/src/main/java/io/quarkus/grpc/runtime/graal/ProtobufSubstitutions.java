...
@TargetClass(value = GeneratedMessageV3.class,
        innerClass = {"FieldAccessorTable", "RepeatedFieldAccessor"}
)
...
@SuppressWarnings("unused")
@TargetClass(value = GeneratedMessageV3.class,
        innerClass = {"FieldAccessorTable", "SingularFieldAccessor"}
)
...
@TargetClass(value = GeneratedMessageV3.class,
        innerClass = {"FieldAccessorTable", "RepeatedFieldAccessor", "MethodInvoker"})
...
@TargetClass(value = GeneratedMessageV3.class,
        innerClass = {"FieldAccessorTable", "SingularFieldAccessor", "MethodInvoker"})
...
@TargetClass(value = GeneratedMessageV3.class,
        innerClass = {"FieldAccessorTable", "RepeatedFieldAccessor", "ReflectionInvoker"})
...
@TargetClass(value = GeneratedMessageV3.class,
        innerClass = {"FieldAccessorTable", "SingularFieldAccessor", "ReflectionInvoker"})
