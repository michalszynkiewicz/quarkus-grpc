...
[source,protobuf]
----
include::../runtime/src/main/proto/health.proto[]
----
...
|quarkus.grpc-server.ssl.certificate.file | The path to the certificate file to use.  |
|quarkus.grpc-server.ssl.certificate.key-file | The path to the key file to use.  |
|quarkus.grpc-server.ssl.certificate.key-store-file | The path to the keystore file to use.  |
|quarkus.grpc-server.ssl.certificate.key-store-file-type | The type of the key store file.   | based on file name
|quarkus.grpc-server.ssl.certificate.key-store-password | The key store password.  | `password`
|quarkus.grpc-server.ssl.certificate.trust-store-file | The path to the trust store file.  |
|quarkus.grpc-server.ssl.certificate.trust-store-file-type | The type of the trust store file.  | based on file name
|quarkus.grpc-server.ssl.certificate.trust-store-password | The trust store password. |
